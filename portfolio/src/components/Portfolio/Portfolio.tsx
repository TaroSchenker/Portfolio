...
const Portfolio = () => {
  ...
  return (
    <section id="portfolio" className="py-20 px-6 sm:px-12 lg:px-24 bg-gray-800 text-white">
      <animated.div style={fadeIn} className="text-left">
        <h2 className="text-4xl mb-6 font-semibold text-center">My Projects</h2>
        <Container>
          <Row>
            {projects.map((project) => (
              <Col sm={12} md={6} lg={4} key={project.id} className="mb-4">
                ...
                >
                  <img src={project.image} alt={project.name} className="w-full h-64 object-cover rounded shadow" />
