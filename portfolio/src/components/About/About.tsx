  ...
  return (
    <section id="about" className="flex flex-col items-center py-20 px-6 sm:px-12 lg:px-24 bg-gray-800 text-white">
      <animated.div style={fadeIn} className="mx-auto max-w-2xl text-left">
        ...
        <p className="text-lg leading-relaxed mb-4">
        I thrive on innovation and growth, leveraging my musical background to bring creative solutions to tech. I enjoy learning new instruments and experimenting with audio software in my free time. 
        </p>
        <p className="text-lg leading-relaxed mb-4">
